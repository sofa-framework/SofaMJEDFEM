...
******************************************************************************/
#ifndef SOFA_COMPONENT_FEM_VERONDAWESTMANMJED_H
#define SOFA_COMPONENT_FEM_VERONDAWESTMANMJED_H
...
class VerondaWestmanMJED : public HyperelasticMaterialMJED<DataTypes>{
