...
******************************************************************************/
#ifndef SOFA_COMPONENT_FEM_HYPERELASTICMATERIALMJED_H
#define SOFA_COMPONENT_FEM_HYPERELASTICMATERIALMJED_H
...
public:
	...
	typedef typename defaulttype::Mat<6,6,Real> Matrix6;
  ...
  typedef typename Eigen::SelfAdjointEigenSolver<Eigen::Matrix<Real,3,3> >::RealVectorType CoordEigen;
   ...
   virtual ~HyperelasticMaterialMJED(){}
	...
	struct MaterialParameters {
		...
		e.g. 2 Lamé coefficients for St-Venant Kirchhoff materials */
